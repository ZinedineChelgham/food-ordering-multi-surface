...
return (
        <div style={{ height:'100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <div style={{ height:'80%', display: 'flex', flexDirection: 'row',overflow: 'hidden' }}>
                ...
                {/* Deuxième commande */}
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    <AppBarMultiOrder title="Commande 2" showBackButton onBackButtonClick={handleBackButtonClick}/>
                    <NavPlusList
                        handleCategoryChange={handleCategoryChange}
                        foodItems={foodItems[category]}
                        currCat={category}
                ...
                {/* Troisième commande */}
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    <AppBarMultiOrder title="Commande 3" showBackButton onBackButtonClick={handleBackButtonClick} />
                    <NavPlusList
                        handleCategoryChange={handleCategoryChange}
                        foodItems={foodItems[category]}
                        currCat={category}
