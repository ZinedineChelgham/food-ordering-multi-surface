...
function NavPlusList({ foodItems, currCat, handleCategoryChange, isMultiOrder }) {
  ...
  return (
    ...
    >
      <div style={{ height: "20%" }}>
        <NavBar handleCategoryChange={handleCategoryChange} currCat={currCat} isMultiOrder={isMultiOrder} />
      </div>
